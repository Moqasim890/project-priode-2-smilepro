		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 text-center">
				<div class="ratio ratio-16x9 rounded shadow overflow-hidden">
					<img src="https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&w=1200&q=80" alt="Tandheelkunde SmilePro" class="w-100 h-100 object-fit-cover">
				</div>
			</div>
		</div>
	</div>
