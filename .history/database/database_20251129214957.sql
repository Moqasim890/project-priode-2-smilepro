...
-- Eerst personen aanmaken (zonder gebruikerid, losse personen voor patienten)
INSERT INTO persoon (gebruikerid, voornaam, tussenvoegsel, achternaam, geboortedatum, isactief) VALUES
(NULL, 'Jan', 'de', 'Vries', '1985-03-15', 1),
(NULL, 'Sarah', NULL, 'Bakker', '1992-07-22', 1),
(NULL, 'Mohammed', NULL, 'Ali', '1978-11-08', 1);

-- Patienten (gebruik de zojuist aangemaakte personen - IDs 4, 5, 6 als er al 3 personen bestaan)
-- Als database leeg is worden dit IDs 1, 2, 3
INSERT INTO patient (persoonid, nummer, medischdossier, isactief) VALUES
((SELECT MAX(id) - 2 FROM persoon), 'P00001', 'Regelmatige controles, geen bijzonderheden', 1),
((SELECT MAX(id) - 1 FROM persoon), 'P00002', 'Gevoelige tanden, regelmatig tandsteen', 1),
((SELECT MAX(id) FROM persoon), 'P00003', 'Orthodontie behandeling in 2023 afgerond', 1);
...
(1, 'Hoofdstraat', '123', '1234AB', 'Utrecht', '0612345678', 'admin@smilepro.nl', 1),
(2, 'Kerkstraat', '45', '5678CD', 'Utrecht', '0687654321', 'medewerker@smilepro.nl', 1),
(3, 'Plein', '7', '9012EF', 'Utrecht', '0698765432', 'klant@smilepro.nl', 1);
