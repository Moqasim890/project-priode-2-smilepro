...
<div class="container py-5">
	<div class="d-flex justify-content-between align-items-center mb-4">
		<h1 class="h3 fw-bold">
			<i class="bi bi-envelope-plus me-2"></i>Patient toevoegen
		</h1>
    ...
    <div class="border p-2 shadow-sm overflow-y-auto" style="max-height: 60dvh; height: 60dvh;">
        <form action="{{ route('admin.berichten.store') }}" method="post">
            ...
            <div class="mb-3">
                <label for="medischdossier" class="form-label">Medischdossier</label>
                <input class="form-control" type="file" id="medischdossier" name="medischdossier">
            </div>

            <div class="mb-3">
                <label for="opmerking" class="form-label">Opmerking:</label>
                <input type="text" class="form-control" id="opmerking" name="opmerking" placeholder="name@example.com">
            </div>
            <div class="d-flex">
