...
Route::middleware(['auth', 'role:Praktijkmanagement,Tandarts,Mondhygiënist,Assistent'])->prefix('medewerker')->group(function () {
    ...
    Route::get('/facturen/create', [FactuurController::class, 'create'])->name('medewerker.factuur.create');
    Route::put('/facturen/store', [FactuurController::class, 'store'])->name('medewerker.factuur.store');
    Route::get('/facturen/edit', [FactuurController::class, 'edit'])->name('medewerker.factuur.edit');
    Route::patch('/facturen/update', [FactuurController::class, 'update'])->name('medewerker.factuur.update');
    Route::get('/factuur/behandelingen/{patientId}', [FactuurController::class, 'Getbehandelingen'])->name('medewerker.behandeling.api');
